-- Script para agregar productos de prueba a Samacá Store
...
VALUES 
  ...
  (
    ...
    'Zapatos deportivos con tecnología Air Max para máxima comodidad. Perfectos para correr o uso diario.',
    150000,
    'zapatos',
    ...
    15,
    ARRAY['nuevo', 'deportivo']
  ),
  (
    'Zapatos Casuales Adidas',
    'Zapatos casuales elegantes para el día a día. Diseño moderno y cómodo.',
    120000,
    'zapatos',
  ...
  (
    ...
    'Botas de cuero genuino, perfectas para clima frío. Estilo y durabilidad.',
    180000,
    'zapatos',
    ...
    ARRAY['Café', 'Negro'],
    5,
    ARRAY['nuevo', 'invierno']
  ),
  (
    'Sandalias de Verano',
    'Sandalias cómodas y frescas para el verano. Diseño moderno.',
    45000,
    'zapatos',
  ...
  (
    ...
    'Camiseta de algodón 100% premium. Suave, cómoda y duradera.',
    45000,
    'ropa',
  ...
  (
    'Camisa Formal Elegante',
    'Camisa formal de vestir, perfecta para ocasiones especiales.',
    75000,
    'ropa',
  ...
  (
    'Jeans Clásicos Levis',
    'Jeans de mezclilla de alta calidad. Corte clásico y cómodo.',
    95000,
    'ropa',
  ...
  (
    'Chaqueta de Cuero',
    'Chaqueta de cuero sintético de alta calidad. Estilo rockero.',
    150000,
    'ropa',
  ...
  (
    ...
    'Vestido casual con estampado floral. Perfecto para primavera.',
    85000,
    'ropa',
  ...
  (
    ...
    'Sudadera cómoda con capucha. Ideal para clima frío.',
    65000,
    'ropa',
    ...
    15,
    ARRAY['casual', 'invierno']
  ),

  -- ACCESORIOS
  (
    'Bolso de Cuero Elegante',
    'Bolso de cuero genuino para toda ocasión. Espacioso y elegante.',
    85000,
    'accesorios',
    ...
    8,
    ARRAY['nuevo', 'elegante']
  ),
  (
    'Gorra Deportiva Nike',
    'Gorra deportiva ajustable. Protección solar y estilo.',
    35000,
    'accesorios',
  ...
  (
    'Cinturón de Cuero',
    'Cinturón de cuero genuino con hebilla metálica.',
    40000,
    'accesorios',
  ...
  (
    ...
    'Gafas de sol con protección UV. Diseño moderno.',
    55000,
    'accesorios',
  ...
  (
    ...
    'Reloj digital resistente al agua. Múltiples funciones.',
    75000,
    'accesorios',
    ...
    5,
    ARRAY['deportivo', 'nuevo']
  ),
  (
    'Mochila Urbana',
    'Mochila espaciosa para laptop y uso diario. Resistente.',
    95000,
    'accesorios',
  ...
  (
    'Bufanda de Lana',
    'Bufanda suave de lana para clima frío. Elegante y cálida.',
    30000,
    'accesorios',
